...
**Scope note (2026-09-03):** this file audits `ROSTER_POSTMORTEM.md`, not the code, and it is
**not** the parent of `ROSTER_QC_AUDIT_FOUNDATIONS.md`, `…_PRIMITIVES.md` and `…_SURFACES.md` —
those are separate, later audits of engine packages (2026-08-11/12). Every `file:line` below is
against a ~500-line `RosterView.jsx`; the file is over 4,000 lines now and none of them resolve.
