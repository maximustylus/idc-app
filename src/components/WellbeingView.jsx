...
const WellbeingView = () => {
    ...
    return (
        // FIX: Removed max-w constraints. Added w-full and flex-center alignment.
        <div className="w-full h-full px-4 py-6 md:px-8 md:py-8 space-y-8 animate-in fade-in duration-700 flex flex-col items-center">
            
            {/* 1. HERO SECTION: Full Width Dashboard Strip */}
            <div className="w-full bg-slate-900 rounded-3xl p-8 lg:p-10 text-white shadow-2xl relative overflow-hidden border border-slate-800 flex flex-col xl:flex-row items-center justify-between gap-10">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left min-w-fit">
                    ...
                    <div>
                        ...
                        <div className="flex items-baseline justify-center sm:justify-start gap-1">
                            <span className="text-6xl lg:text-7xl font-black tracking-tighter text-white drop-shadow-lg">
                                {stats.avg}
                            </span>
                            <span className="text-3xl font-bold text-slate-500">%</span>
                        </div>
                        
                        <div className={`mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold border backdrop-blur-md ${
                ...
                <div className="w-full flex-1 max-w-5xl flex flex-col justify-center space-y-3 px-2 lg:px-8">
                    ...
                    <div className="h-8 w-full bg-slate-800/60 rounded-full overflow-hidden backdrop-blur-sm border border-slate-700/50 relative shadow-inner">
                        {/* Tick Marks */}
            ...
            {/* 2. LIVE STATUS GRID: Stretches to fill container */}
            <div className="w-full">
                <div className="flex items-center gap-3 mb-6 pl-2">
                    ...
                    <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200 uppercase tracking-tight">
                        Live Team Status
                    </h3>
                </div>
                
                {/* GRID LOGIC FIX: 
                   Using 'w-full' and expanding '2xl' to 6 columns ensures it uses 
                   monitor width effectively on large screens. 
                */}
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-6">
                    {STAFF_LIST.map((name) => {
                        ...
                        return (
                            <div key={name} className="group bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-[180px]">
                                ...
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="bg-slate-50 dark:bg-slate-700/50 p-2.5 rounded-xl shrink-0">
