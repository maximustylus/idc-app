...
const WellbeingView = () => {
    ...
    return (
        // FIX 1: 'mx-auto' forces it to the middle. 'max-w-[1600px]' prevents it from getting too wide on IMAX screens.
        <div className="w-full max-w-[1600px] mx-auto p-6 md:p-10 space-y-10 animate-in fade-in duration-700">
            ...
            <div className="w-full">
                ...
                {/* FIX 2: Capped at 4 Columns (xl:grid-cols-4). 
                   This prevents the "squished" 6-column look and fills the screen better. */}
